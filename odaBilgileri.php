...
// Odalar tablosundan verileri çek
$query = $db->query("SELECT * FROM odalar");
$odalar = $query->fetchAll(PDO::FETCH_ASSOC);
  ...
  <table class="table">
    <thead>
      <tr>
        ...
        <th scope="col">Dahili Numara</th>
        <th scope="col">Gorevli ID </th>
