...
<h2>Hasta Ekle</h2>
  <form action="hasta_ekle.php" method="post">
    <div class="mb-3">
      ...
      <input type="text" class="form-control" id="hasta_tc" name="hasta_tc" required>
    </div>
    <div class="mb-3">
      <label for="hasta_adi" class="form-label">Hasta Adı</label>
      <input type="text" class="form-control" id="hasta_adi" name="hasta_adi" required>
    </div>
    <div class="mb-3">
      <label for="hasta_soyadi" class="form-label">Hasta Soyadı</label>
      <input type="text" class="form-control" id="hasta_soyadi" name="hasta_soyadi" required>
    </div>
    <div class="mb-3">
      <label for="hasta_telefon" class="form-label">Hasta Telefon</label>
      <input type="tel" class="form-control" id="hasta_telefon" name="hasta_telefon" required>
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
      ...
      <input type="text" class="form-control" id="hasta_adres" name="hasta_adres" required>
    </div>
    <div class="mb-3">
      <label for="randevu_gun" class="form-label">Randevu Gün</label>
      <input type="text" class="form-control" id="randevu_gun" name="randevu_gun" required>
    </div>
    <div class="mb-3">
      <label for="randevu_saat" class="form-label">Randevu Saat</label>
      <input type="text" class="form-control" id="randevu_saat" name="randevu_saat" required>
    </div>
    <div class="mb-3">
      <label for="taburcu_tarih" class="form-label">Taburcu Tarih</label>
      <input type="text" class="form-control" id="taburcu_tarih" name="taburcu_tarih" required>
    </div>
    <div class="mb-3">
      <label for="taburcu_tarih" class="form-label">Sorumlu Hemsire ID'si </label>
      <input type="text" class="form-control" id="hemsire_id" name="hemsire_id" required>
    </div>
