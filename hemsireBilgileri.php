...
// Hemsire tablosundan verileri çek
$query = $db->query("SELECT * FROM hemsire");
$hemsireler = $query->fetchAll(PDO::FETCH_ASSOC);
?>
...
<h2>Hemşire Listesi</h2>
    <table class="table">
        <thead>
        <tr>
            <th scope="col">Hemşire ID</th>
            <th scope="col">TC</th>
            <th scope="col">Adı</th>
        ...
        <tbody>
        <?php foreach ($hemsireler as $hemsire): ?>
            <tr>
                <td><?= $hemsire['hemsire_id'] ?></td>
                <td><?= $hemsire['hemsire_tc'] ?></td>
                <td><?= $hemsire['hemsire_adi'] ?></td>
                <td><?= $hemsire['hemsire_soyadi'] ?></td>
                <td><?= $hemsire['hemsire_adres'] ?></td>
                <td><?= $hemsire['hemsire_telefon'] ?></td>
            </tr>
        <?php endforeach; ?>
        </tbody>
    </table>
