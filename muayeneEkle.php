...
<h2>Muayene Formu</h2>
    ...
    <form method="post" action="muayene_ekle.php">
        <div class="mb-3">
            <label for="hasta_id" class="form-label">Hasta ID</label>
            <input type="text" class="form-control" id="hasta_id" name="hasta_id" required>
        </div>
        <div class="mb-3">
            <label for="doktor_id" class="form-label">Doktor ID</label>
            <input type="text" class="form-control" id="doktor_id" name="doktor_id" required>
        </div>
        <div class="mb-3">
            <label for="tedavi" class="form-label">Tedavi</label>
            <textarea class="form-control" id="tedavi" name="tedavi" required></textarea>
        </div>
