...
<h2>Hizmetli Ekle</h2>
  <form action="hizmetliEkle.php" method="post">
    <div class="mb-3">
      <label for="tc" class="form-label">TC</label>
      <input type="text" class="form-control" id="tc" name="tc" required>
    </div>
    <div class="mb-3">
      <label for="hizmetli_adi" class="form-label">Hizmetli Adı</label>
      <input type="text" class="form-control" id="hizmetli_adi" name="hizmetli_adi" required>
    </div>
    <div class="mb-3">
      <label for="hizmetli_soyadi" class="form-label">Hizmetli Soyadı</label>
      <input type="text" class="form-control" id="hizmetli_soyadi" name="hizmetli_soyadi" required>
    </div>
    <button type="submit" class="btn btn-primary">Hizmetli Ekle</button>
  </form>
</div>
</div>
