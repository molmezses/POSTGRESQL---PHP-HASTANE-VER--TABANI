...
<h2>Reçete Ekle</h2>
    ...
    <form method="post" action="recete_ekle.php">
        <div class="mb-3">
            <label for="ilac_kodu" class="form-label">İlaç Kodu</label>
            <input type="text" class="form-control" id="ilac_kodu" name="ilac_kodu" required>
        </div>
        <div class="mb-3">
            <label for="recete_sahibi_hasta_tc" class="form-label">Reçete Sahibi Hasta TC</label>
            <input type="text" class="form-control" id="recete_sahibi_hasta_tc" name="recete_sahibi_hasta_tc" required>
        </div>
